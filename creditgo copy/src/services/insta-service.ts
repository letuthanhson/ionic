...
export class InstaService{
    ...
    getCounterpartyCurrentLimitsAndExposures(counterpartyName: string): Observable<any> {
     ...
     getCounterpartyForwardLimitsAndExposures(id: number): Observable<any> {

        // let jsonReq = '{ "counterpartyName": "' + counterpartyName + '" }';
        // console.log("Getting cp/forward exposure - name:userid:json " + counterpartyName + ":" + this.userid + ":" + jsonReq);
        ...
        // return this.getData(req);
         ...
         return this.http.get('mock/forwardexposure.json')
            .map(res => res.json())
            .catch(this.handleError);
    }
    // mock
